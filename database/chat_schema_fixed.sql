-- Live Chat System Database Schema (FIXED)
...
-- RLS Policies for chat_rooms (FIXED - removed text casting)
...
-- RLS Policies for chat_messages (FIXED)
...
-- RLS Policies for chat_participants (FIXED)
...
-- RLS Policies for chat_typing (FIXED)
...
-- RLS Policies for chat_assignments (FIXED)
