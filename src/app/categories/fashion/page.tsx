  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        const catRes = await fetch('/api/categories?slug=fashion')
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-4xl font-bold text-slate-900 mb-2">Fashion</h1>
              <p className="text-slate-600">Discover the latest trends in clothing and accessories</p>
            </div>
