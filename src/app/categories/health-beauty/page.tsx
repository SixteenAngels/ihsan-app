...
const healthBeautyProducts: Product[] = [
  {
    id: '1',
...
const subcategories = [
  { name: 'Skincare', icon: Droplets, href: '/categories/skincare', count: 456 },
  { name: 'Makeup', icon: Sparkles, href: '/categories/makeup', count: 234 },
  { name: 'Fragrance', icon: HeartIcon, href: '/categories/fragrance', count: 123 }
]

const brands = ['The Ordinary', 'Olay', 'CeraVe', 'Fenty Beauty', 'MAC', 'Urban Decay', 'Chanel', 'Tom Ford', 'Neutrogena', 'Too Faced', 'Dior', 'Clinique']
const categories = ['Skincare', 'Makeup', 'Fragrance']
const skinTypes = ['All Skin Types', 'Dry Skin', 'Oily Skin', 'Combination', 'Sensitive', 'Mature Skin']
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <span className="text-slate-900">Health & Beauty</span>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-4xl font-bold text-slate-900 mb-2">Health & Beauty</h1>
              <p className="text-slate-600">Premium skincare, makeup, and fragrance products</p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 mb-6">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search health & beauty..."
        ...
        <div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : 'grid-cols-1'}`}>
          {healthBeautyProducts.map((product) => (
            <Card key={product.id} className="product-card group hover:shadow-xl transition-all duration-300 border-0 shadow-md">
              <div className="relative overflow-hidden">
                ...
                {product.badge && (
                  <Badge className={`absolute top-3 right-3 text-xs ${
                    ...
                    product.badge === 'Essential' ? 'badge-new' :
              ...
              <CardContent className="p-4">
                ...
                <div className="text-sm text-slate-600 mb-2 space-y-1">
                  ...
                  <div><span className="font-medium">Skin Type:</span> {product.skinType}</div>
                  {product.volume && <div><span className="font-medium">Volume:</span> {product.volume}</div>}
                </div>
